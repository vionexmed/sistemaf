  ...
  return (
    <P.Root open={aberto} onOpenChange={aoMudar}>
      <P.Portal>
        ...
        <P.Content className="fixed top-1/2 left-1/2 z-50 w-[calc(100%-32px)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-md border bg-surface p-6 shadow-overlay">
